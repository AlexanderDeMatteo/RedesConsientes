        ...
        <>
            <div className="sidebar" style={{ width: isOpen ? "260px" : "85px" }} >
                <div className="logo-details">
                    <i id="sideBarIcon"class="fa-solid fa-bars" id="btn" onClick={toggle}></i>
                ...
                <ul className="nav-list">
                    <li>
                        ...
                        <a onClick={() => setContentPerfil(!contentPerfil)}>
                            <i id="sideBarIcon"class="fa-regular fa-user"></i>
                        ...
                        {contentPerfil && <ul className="ulContent">
                            <li>
                                <a href="/perfil">
                                    <i id="sideBarIcon"class="fa-regular fa-address-card"></i>
                                    <span className="links_name" style={{ opacity: isOpen ? "1" : "0", display: !isOpen ? "none" : "block" }}>Perfil</span>
                                </a>
                            </li>
                            <li>
                                <a href="/sessions">
                                    <i id="sideBarIcon"class="fa-solid fa-house-laptop"></i>
                            ...
                            <li onClick={() => handleClick(calendar_today)} >
                                <a>
                                    <i id="sideBarIcon"class="fa-solid fa-book"></i>
                            ...
                            <li>
                                <a>
                                    <i id="sideBarIcon"class="fa-regular fa-address-book"></i>
                    ...
                    <li>
                        <a onClick={() => setContentAdmPaciente(!contentAdmPaciente)}>
                            <i id="sideBarIcon"class="fa-solid fa-users"></i>
                        ...
                        {contentAdmPaciente && <ul className="ulContent">
                            <li>
                                <a href="/Expedientes">
                                    <i id="sideBarIcon"class="fa-regular fa-folder"></i>
                            ...
                            <li onClick={() => handleClick(calendar)} >
                                <a>
                                    <i id="sideBarIcon"class="fa-solid fa-book-open"></i>
                    ...
                    <li>
                        <a onClick={() => setContentadmCuenta(!contentadmCuenta)}>
                            <i id="sideBarIcon"class="fa-solid fa-money-bill-trend-up"></i>
                    ...
                    <li>
                        <a onClick={() => setContentNavega(!contentNavega)}>
                            <i id="sideBarIcon"class="fa-solid fa-globe"></i>
                        ...
                        {contentNavega && <ul className="ulContent">
                            <li>
                                <a>
                                    <i id="sideBarIcon"class="fa-regular fa-newspaper"></i>
                            ...
                            <li>
                                <a href="/buscador">
                                    <i id="sideBarIcon"class="fa-solid fa-users-viewfinder"></i>
                            ...
                            <li>
                                <a>
                                    <i id="sideBarIcon"class="fa-solid fa-store"></i>
