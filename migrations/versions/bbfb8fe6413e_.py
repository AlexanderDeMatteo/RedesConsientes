...
Revision ID: bbfb8fe6413e
Revises: 
Create Date: 2024-05-29 20:52:27.754239
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type_of_session', sa.String(length=50), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('phone_number', sa.Numeric(precision=25), nullable=True),
