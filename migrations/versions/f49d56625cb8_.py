...
Revision ID: f49d56625cb8
Revises: 
Create Date: 2024-10-14 14:57:48.247668
...
def upgrade():
    ...
    sa.Column('day', sa.Numeric(precision=2), nullable=True),
    sa.Column('month', sa.Numeric(precision=2), nullable=True),
    ...
    sa.Column('notification_type', sa.Enum('new_session', 'reminder', 'message', 'system', 'payment', 'market', name='notificationtype'), nullable=False),
